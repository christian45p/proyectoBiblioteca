...
<h2 class="font-italic text-muted col-md-12 h4">Usuario</h2>
<div class="form-row">
...
<div class="col-md-12">
     <div class="p-4">
        <form role="form" name="registro" action="<?php echo base_url();?>index.php/administrador/insert_usuario" method="post">
