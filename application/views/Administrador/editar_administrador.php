<div class="card mb-4 border border-dark m-5 rounded-lg">
    ...
    <div class="card-body">
        <form action="<?= base_url('administrador/evaluaActualizarDatos/')?>" method="post">
            <input type="hidden" name="id" value="<?= $usuario->usua_id?>">
            <div class="form-row">
                <div class="form-group col-md-3 disabled">
                    <label for="">Codigo del Administrador</label>
            ...
            <div class="form-group">
                <input type="hidden" class="form-control form-control-sm border border-dark" value="<?= $usuario->usua_esadmin?>" id="inputAddress" name="usua_esadmin" >
            </div>
            <div class="form-row">
